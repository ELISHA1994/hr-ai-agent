...
async function generateSyntheticData(): Promise<Employee[]> {
    ...
    Each record should include the following fields: employee_id, first_name, last_name, date_of_birth, address, contact_details, 
    job_details, work_location, reporting_manager, skills, performance_reviews, benefits, emergency_contact, notes. 
...
async function seedDatabase(): Promise<void> {
    try {
        ...
        console.log("Inserting synthetic data into the database...", syntheticData);
        ...
        console.log("Generating employee summary", recordsWithSummaries);
